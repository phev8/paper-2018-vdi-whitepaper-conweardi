...
Challenges included for such businesses are different than those a big multinational corporation with thousands of workers has to face. 
Most construction projects are small projects. Nearly 2 million craftsman in Germany work mainly in smaller projects up to 100,000 euros. 
The project planning for smaller projects is more intensive because every project has specific aspects that need to be considered and the work tasks need to be scheduled on an individual basis. 
Therefore, ConWearDi focuses on an important economic group that faces many challenges.
